...
import cn.ltl.solrj.pojo.Foo;
import cn.ltl.solrj.service.SolrjService;
...
public class SolrjServiceTest {
    ...
    public void testDelete() throws Exception {
        this.solrjService.delete(Arrays.asList("1510813496789"));
//        httpSolrServer.deleteById(Arrays.asList("1510813112067"));
