...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='购物车模块';
...
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8 COMMENT='内容分类';
...
CREATE TABLE `tb_item` (
  ...
  KEY `status` (`status`),
  KEY `updated` (`updated`)
) ENGINE=InnoDB AUTO_INCREMENT=1474391933 DEFAULT CHARSET=utf8 COMMENT='商品表';
...
-- ----------------------------
-- Table structure for tb_item_bak
-- ----------------------------
DROP TABLE IF EXISTS `tb_item_bak`;
CREATE TABLE `tb_item_bak` (
...
-- ----------------------------
-- ----------------------------
-- Table structure for tb_item_desc_bak
-- ----------------------------
DROP TABLE IF EXISTS `tb_item_desc_bak`;
CREATE TABLE `tb_item_desc_bak` (
  `item_id` bigint(20) DEFAULT NULL COMMENT '商品ID',
  `item_desc` text COMMENT '商品描述',
  `created` datetime DEFAULT NULL COMMENT '创建时间',
  `updated` datetime DEFAULT NULL COMMENT '更新时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='商品规则参数';
